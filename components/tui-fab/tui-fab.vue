			...
			<view class="tui-fab-btn" :class="{'tui-visible':isOpen,'tui-fab-hidden':hidden}">
				<view class="tui-fab-item-box" :class="{'tui-fab-item-left':left && !right && item.imgUrl}" v-for="(item,index) in btnList"
				 :key="index" @tap.stop="handleClick(index)">
					...
					<view class="open-type" v-if="item.openType">
						<button class="btn" v-if="item.openType=='share'" type="default" open-type="share"></button>
						<button class="btn" v-if="item.openType=='contact'" type="default" open-type="contact" @contact="openTypeCallback"></button>
						<button class="btn" v-if="item.openType=='getPhoneNumber'" type="default" open-type="getPhoneNumber" @getphonenumber="openTypeCallback"></button>
						<button class="btn" v-if="item.openType=='getUserInfo'" type="default" open-type="getUserInfo" @getuserinfo="openTypeCallback"></button>
						<button class="btn" v-if="item.openType=='launchApp'" type="default" open-type="launchApp"></button>
						<button class="btn" v-if="item.openType=='openSetting'" type="default" open-type="openSetting"></button>
						<button class="btn" v-if="item.openType=='feedback'" type="default" open-type="feedback"></button>
					</view>

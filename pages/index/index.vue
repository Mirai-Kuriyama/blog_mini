<template>
	<view class="index">
		<!-- <button type="default" open-type="getUserInfo" @getuserinfo="getUserInfo">获取心</button> -->
		
		<view class="DrawerPage" :class="modalName=='viewModal'?'show':''">
			
			<gesture direction="horizontal" @slideRight="slideRight" @slideLeft="slideLeft">
...
<script>
	...
	export default {
		...
		methods: {
			...
			getData(data) {
				this.$request("/api/article/wxlist",data).then(res=>{
